import { B as Block, S as Static, o as IconButtonWrapper, F as FullscreenButton, W as BlockTitle, n as Empty, aq as LineChart, ak as globals } from './2-Biti84Oc.js';
...
const Index = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  async function load_chart() {
    ...
    if (!vegaEmbed) {
      vegaEmbed = (await import('./vega-embed.module-CE826wjX.js')).default;
    }
    vegaEmbed(chart_element, spec, { actions: false }).then(function(result) {
      view = result.view;
      resizeObserver.observe(chart_element);
...
//# sourceMappingURL=Index28-DfjIoRVk.js.map
