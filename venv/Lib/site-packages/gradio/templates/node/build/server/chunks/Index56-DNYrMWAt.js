...
import { B as Block, S as Static, j as BlockLabel, J as File$1, n as Empty, U as UploadText, o as IconButtonWrapper, q as IconButton, P as Undo, u as Download } from './2-Biti84Oc.js';
import { U as Upload, M as ModifyUpload } from './ModifyUpload-BVseLUEs.js';
...
async function loadCanvas3D$1() {
  const module = await import('./Canvas3D-DbHBK0ak.js');
  return module.default;
}
async function loadCanvas3DGS$1() {
  const module = await import('./Canvas3DGS-D-wZrzdc.js');
  return module.default;
}
...
//# sourceMappingURL=Index56-DNYrMWAt.js.map
