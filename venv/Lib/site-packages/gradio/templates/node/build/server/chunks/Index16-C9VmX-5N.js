...
import { B as Block, S as Static, j as BlockLabel, X as Code$2, n as Empty, q as IconButton, K as Copy$1, D as DownloadLink, u as Download$1, o as IconButtonWrapper, Y as getWorkerProxyContext } from './2-Biti84Oc.js';
...
const lang_map = {
  python: () => import('./index33-C_9grjmk.js').then((m) => m.python()),
  ...
  markdown: async () => {
    const [md, frontmatter] = await Promise.all([
      import('./index34-Bv8ulRYr.js'),
      import('./frontmatter-BPn90kth.js')
    ]);
  ...
  json: () => import('./index38-BdbWCDvA.js').then((m) => m.json()),
  html: () => import('./index35-BWIaERYC.js').then((m) => m.html()),
  css: () => import('./index36-bhx_v1dI.js').then((m) => m.css()),
  javascript: () => import('./index37-BGTzGbKp.js').then((m) => m.javascript()),
  jinja2: () => import('./jinja2-BxhAu_54.js').then(
    (m) => StreamLanguage.define(m.jinja2)
  ),
  typescript: () => import('./index37-BGTzGbKp.js').then(
...
//# sourceMappingURL=Index16-C9VmX-5N.js.map
