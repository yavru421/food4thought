const __vite__fileDeps=["./index.UYU_Fg2v.js","./index.D8XASVsu.js","./index.CKyzpVIm.js","./index.CWZvVoy4.js","./index.CaOfbK3C.js","./index.Cf3LYxXl.js","./frontmatter.B0BsWD6L.js","./yaml.BMKOA8H-.js","./index.BjPulKWP.js"],__vite__mapDeps=i=>i.map(i=>__vite__fileDeps[i]);
...
import { n as getWorkerProxyContext, I as IconButton, R as Check, U as Copy$1, B as Block, S as Static } from "./2.C618WuEn.js";
...
const lang_map = {
  python: () => __vitePreload(() => import("./index.UYU_Fg2v.js"), true ? __vite__mapDeps([0,1]) : void 0, import.meta.url).then((m) => m.python()),
  ...
  markdown: async () => {
    const [md, frontmatter] = await Promise.all([
      __vitePreload(() => import("./index.CKyzpVIm.js"), true ? __vite__mapDeps([2,3,1,4,5]) : void 0, import.meta.url),
      __vitePreload(() => import("./frontmatter.B0BsWD6L.js"), true ? __vite__mapDeps([6,7]) : void 0, import.meta.url)
    ]);
  ...
  json: () => __vitePreload(() => import("./index.BjPulKWP.js"), true ? __vite__mapDeps([8,1]) : void 0, import.meta.url).then((m) => m.json()),
  html: () => __vitePreload(() => import("./index.CWZvVoy4.js"), true ? __vite__mapDeps([3,1,4,5]) : void 0, import.meta.url).then((m) => m.html()),
  css: () => __vitePreload(() => import("./index.CaOfbK3C.js"), true ? __vite__mapDeps([4,1]) : void 0, import.meta.url).then((m) => m.css()),
  javascript: () => __vitePreload(() => import("./index.Cf3LYxXl.js"), true ? __vite__mapDeps([5,1]) : void 0, import.meta.url).then((m) => m.javascript()),
  jinja2: () => __vitePreload(() => import("./jinja2.2Vo2sGef.js"), true ? [] : void 0, import.meta.url).then(
    (m) => StreamLanguage.define(m.jinja2)
  ),
  typescript: () => __vitePreload(() => import("./index.Cf3LYxXl.js"), true ? __vite__mapDeps([5,1]) : void 0, import.meta.url).then(
